...
VITE_API_BASE_URL=https://192.168.2.111:${FRONTEND_HTTPS_PORT}  # Use HTTPS through nginx proxy
VITE_WS_BASE_URL=wss://192.168.2.111:${FRONTEND_HTTPS_PORT}/api/collab
