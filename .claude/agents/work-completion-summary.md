...
4. **Generate audio**:
   - Use `mcp__elevenlabs__text_to_speech` with voice_id "YW25Vx3qQ2GQQNbsIrgZ"
...
- NOTE: The ElevenLabs MCP server must be configured in the mcp.json file with a valid API key for these tools to work.
